    ...
    return  Container(
      child: Stack(
        children: [
                                ...
                                children: [
                                  ...
                                  Container(
                                    child: IconButton(
                                      ...
                                      onPressed:(){
                                        setState(() {
                                          _firebaseServices.usersRef.doc(_firebaseServices.getUserId()).collection("Saved").doc(document.id).delete();
                                        });
                                      },
                                    ),
                                  ),
          ...
          Container(
            child: CustomActionBar(hasBackArrow: false,title: "Saved Products",hasTitile: true,),
          ),
        ],
      ),
    );
